#!/usr/bin/env bash
# Purpose: Download OrgansMNIST from Zenodo and convert to xdata.npy/ydata.npy
...
# ---- Config -----------------------------------------------------------------
readonly URL="https://zenodo.org/records/10519652/files/organsmnist.npz?download=1"
readonly FILENAME="organsmnist.npz"

# Resolve directories (default to ../medmnistS/raw; allow override via RAW_DIR)
SCRIPT_DIR="$(cd -- "$(dirname -- "${BASH_SOURCE[0]}")" && pwd)"
RAW_DIR_DEFAULT="${SCRIPT_DIR}/../medmnistS/raw2"
